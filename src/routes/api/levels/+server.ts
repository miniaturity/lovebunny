...
import { validateLevelPayload, sanitizeText, hashLevel, MIN_MOVES_REQUIRED } from '$lib/server/levels';
...
export const POST: RequestHandler = async ({ request, platform, getClientAddress }) => {
    ...
    if (used >= DAILY_QUOTA_PER_IP) throw error(429, "You've hit today's upload limit, try again tomorrow!");
